const jhonData = {
  ...
  name2: "Shakhboz.",
  name3: "Shakhboz",
  role: "Back End Engineer & Front-End Developer,",
  ptext: "Creative Designer & Developer located in USA.",
  socialLinks: [
    {
      name: "Facebook",
      ...
      menuItems: [
        {
          id: 1,
          icon: "icon_pin_alt",
          text: "Address: Brooklyn, New York 11214",
        },
        {
          id: 2,
          icon: "icon_phone",
          text: "Phone: +1.718.879.2150",
        },
        {
          id: 3,
          icon: "icon_mail",
          text: "Email: shohruh0731@gmail.com",
        },
        {
          id: 4,
          icon: "icon_globe",
